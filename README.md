...
### Веб-сервис
http://127.0.0.1/telegram/ - история ответов бота
http://127.0.0.1/admin/ - администрирование бота
...
```
6. Запустить бот
t.me/CogniMateWeatherBot

* [История ответов бота](http://127.0.0.1/telegram/)
